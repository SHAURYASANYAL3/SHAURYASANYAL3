...
INFO = [
    ("__header__", "shaurya sanyal", ""),
    ("__rule__", "", ""),
    ("Role",     "CS Undergrad & Researcher", "val"),
    ("Focus",    "Full-Stack Development  ·  AI Systems", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "Python · SQL · TypeScript · JavaScript · C/C++", "val"),
    ("Dev",      "Full Stack Development · Product MVP Building", "val"),
    ("AI",       "AI Agents · LLMs · Machine Learning · RL", "val"),
    ("Sec",      "Cybersecurity · Identity & Access Management", "val"),
    ("Infra",    "Linux Fundamentals · Database Design", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("AgentIAM", "AI + Security IAM · Identity & Access Management", "warn"),
    ("E-Vara",   "Digital Reputation Protection (NSOC 26)", "warn"),
    ("SafeRoute","Student safety real-world use case", "warn"),
    ("RyuOS",    "Debian Customization · Systems programming", "warn"),
    ...
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "fool-portfolio.vercel.app", "accent"),
    ("In",       "linkedin.com/in/shaurya-sanyal-7b57a0382", "accent"),
    ("Mail",     "shauryasanyal.21jun@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to Full-Stack / AI Engineer roles</tspan>'
